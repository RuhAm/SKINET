...
# argument parser
parser = argparse.ArgumentParser(description='D2 mix application')
...
for i in range(len(Train1)):
    ...
    # filename = "/mnt/archive/home/aminm2021/Desktop/Trend-filtered SVM/CEU_2/CEU_2_May7/Cropped resized sweep/resized_" + str(Train1[i]) + ".csv"
...
for i in range(len(Train1)):
    ...
    # filename = "/mnt/archive/home/aminm2021/Desktop/Trend-filtered SVM/CEU_2/CEU_2_May7/Cropped resized neutral/resized_" + str(Train1[i]) + ".csv"
    df = pd.read_csv(filename, index_col=0)
...
Xtrain_scaled_path = os.path.join(RES_PATH, 'D2_mix_Xtrain_scaled.csv')
...
Xtest_scaled_path = os.path.join(RES_PATH, 'D2_mix_Xtest_scaled.csv')
...
pred_path = os.path.join(RES_PATH, 'D2_mix_y_pred_aprl3.csv')
pred_proba_path = os.path.join(RES_PATH, 'D2_mix_y_pred_proba_aprl3.csv')
...
cm_display.plot()
cm_path = os.path.join(RES_PATH, 'D2_mix_cm_1000PC.pdf')
plt.savefig(cm_path)
plt.show()
