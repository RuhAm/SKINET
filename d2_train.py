...
# argument parser
parser = argparse.ArgumentParser(description='D2 application')
...
Xtrain_scaled_path = os.path.join(RES_PATH, 'D2Xtrain_scaled.csv')
...
Xtest_scaled_path = os.path.join(RES_PATH, 'D2Xtest_scaled.csv')
...
pred_path = os.path.join(RES_PATH, 'D2_y_pred_aprl3.csv')
pred_proba_path = os.path.join(RES_PATH, 'D2_y_pred_proba_aprl3.csv')
...
cm_display.plot()
cm_path = os.path.join(RES_PATH, 'D2_cm_1000PC.pdf')
plt.savefig(cm_path)
plt.show()
